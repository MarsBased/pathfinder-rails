   ...
   def call
     @template.instance_exec(self) do |pathfinder|
       ...
       *.sublime-*
       ...
       append_file 'Gemfile', "ruby \'#{pathfinder.utils.ask_with_default('Which version of ruby do you want to use?', default: RUBY_VERSION)}\'"

       gem 'rails', pathfinder.utils.ask_with_default('Which version of rails do you want to use?', default: '4.2.5')
